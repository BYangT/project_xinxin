...
<div id="wrap" class="all1">
            ...
            <form action="update.do" method="post">
                <%
                    Idenitfity idenitfity = (Idenitfity) request.getAttribute("iden");
                %>
                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            ...
                            <input type="hidden" name="id" value="<%=idenitfity.getId()%>"/>
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
                            姓名:<%=idenitfity.getUser()%>
                        </td>
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="name" value=""/>
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
                            邮箱:<%=idenitfity.getEmail()%>
                        </td>
                        <td valign="middle" align="left">
                    ...
                    <tr>
                        <td valign="middle" align="right">
                            密码:<%=idenitfity.getPwd()%>
                        </td>
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="pwd" value=""/>
                        </td>
                    </tr>
                </table>
                <p>
